...
## 0. 📜 قانون طلایی (بالاترین اولویت)

> **همیشه فقط فایل زیپ 3 نسخه نهایی را نگه دار و هیچ چیز دیگری را نگه ندار.**

این قانون بالاترین اولویت را دارد و **همیشه و در همه جا** باید رعایت شود:

### جزئیات قانون
- **در پوشه `releases/`**: فقط حداکثر 3 فایل ZIP اخیر نگه داشته شود
- **نسخه‌های قدیمی‌تر**: به‌طور خودکار حذف می‌شوند
- **فایل‌های خارج از ZIP**: فقط فایل‌های ضروری پروژه (کد، تست، مستندات)
- **هیچ فایل اضافی**: در پوشه پروژه نگه‌داری نشود
...
### اجرای خودکار
این قانون در GitHub Actions workflow V2.0.0 به‌صورت خودکار اجرا می‌شود.
